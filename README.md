...
```bash
# Via Helm
helm install paperclip-operator oci://ghcr.io/paperclipai/charts/paperclip-operator

# Or via kubectl
kubectl apply -f https://github.com/paperclipai/k8s-operator/releases/latest/download/install.yaml
```
